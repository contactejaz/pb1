...
4. 10000                    Answer: O(1)
5. log(N) + 1               Answer: O(LogN)
6. log(N) * 3 + 14N + 3     Answer: O(LogN)
7. Nlog(N) + 3N^2           Answer: O(NlogN)
8. N^3 + log(N^4)           Answer: O(N^C)
 ...
 *
 *     Time Complexity: O(N)
 *     Auxiliary Space Complexity: N + N + 2 = O(N)
 */
 ...
 *
 *    Time Complexity: O(N)
 *    Auxiliary Space Complexity: N + 3 = O(N)
 */
 ...
 *   Auxiliary Space Complexity: 4 + N + N = O(N)
 */
 ...
 *
 *   Time Complexity: O(N)
 *   Auxiliary Space Complexity: 2 + N / 2 = O(N)
 */
 ...
 *
 *  Time Complexity: O(N)
 *  Auxiliary Space Complexity: 6 + N + C = O(N)
 */
 ...
 *
 *  Time Complexity: O(N^2)
 *  Auxiliary Space Complexity: 2 + N^2 = O(N^2)
 */
 ...
 *
 *  Time Complexity: O(N^2)
 *  Auxiliary Space Complexity: 3 + N + N * N = O(N^2)
 */
 ...
 *
 *  Time Complexity: O(N)
 *  Auxiliary Space Complexity: 2 + n = O(N)
 */
 ...
 *  Auxiliary Space Complexity: 2 + N ^ 3 = O(N^C)
 */
